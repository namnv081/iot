...
export function ObjectListProvider({ scene, children }) {
  ...
  useEffect(
    () => {
      function updateMediaEntities() {
        ...
        console.log("updateMediaEntities");
        setObjects(objects);
      }
  ...
  useEffect(
    () => {
      function onInspectTargetChanged() {
        const cameraSystem = scene.systems["hubs-systems"].cameraSystem;
        console.log("cameraSystem", cameraSystem);
        const inspectedEl = cameraSystem.inspectable && cameraSystem.inspectable.el;
        console.log("inspectedEl", inspectedEl);
        if (inspectedEl) {
  ...
  const selectObject = useCallback(
    object => {
      handleInspect(scene, object, setSelectedObject);
    },
  ...
  const focusObject = useCallback(
    object => {
      handleInspect(scene, object, setFocusedObject);
    },
  ...
  console.log("focusedObject", focusedObject);
